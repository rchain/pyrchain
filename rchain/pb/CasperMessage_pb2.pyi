...
class BlockRequest(google___protobuf___message___Message):
    base16Hash = ... # type: typing___Text
    hash = ... # type: bytes

    def __init__(self,
        *,
        base16Hash : typing___Optional[typing___Text] = None,
    ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"base16Hash",u"hash"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[u"base16Hash",b"base16Hash",u"hash",b"hash"]) -> None: ...
...
class Header(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"deployCount",u"deploysHash",u"extraBytes",u"parentsHashList",u"postStateHash",u"timestamp",u"version"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[u"deployCount",b"deployCount",u"deploysHash",b"deploysHash",u"extraBytes",b"extraBytes",u"parentsHashList",b"parentsHashList",u"postStateHash",b"postStateHash",u"timestamp",b"timestamp",u"version",b"version"]) -> None: ...
...
class ProduceEvent(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"channelsHash",u"hash",u"sequenceNumber"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[u"channelsHash",b"channelsHash",u"hash",b"hash",u"sequenceNumber",b"sequenceNumber"]) -> None: ...
...
class ConsumeEvent(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"channelsHashes",u"hash",u"sequenceNumber"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[u"channelsHashes",b"channelsHashes",u"hash",b"hash",u"sequenceNumber",b"sequenceNumber"]) -> None: ...
...
class CommEvent(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"consume",u"produces"]) -> None: ...
    else:
